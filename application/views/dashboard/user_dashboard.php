			...
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content no-padding">
					<div class="flot-chart m-t-lg" style="height: 55px;">
						<div class="flot-chart-content" id="flot-chart1" style="padding: 0px; position: relative;"><canvas class="flot-base" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 311px; height: 55px;" width="311" height="55"></canvas><canvas class="flot-overlay" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 311px; height: 55px;" width="311" height="55"></canvas></div>
					</div>
				</div>
						...
						<div class="row">
							<div class="col-md-8">
								<div><iframe class="chartjs-hidden-iframe" style="width: 100%; display: block; border: 0px none; height: 0px; margin: 0px; position: absolute; left: 0px; right: 0px; top: 0px; bottom: 0px;"></iframe>
									<canvas id="lineChart" height="151" style="display: block; width: 398px; height: 151px;" width="398"></canvas>
								</div>
							</div>
							<div class="col-md-4">
		...
		<div class="row">
			<div class="col-sm-9 m-b-xs">
				<div data-toggle="buttons" class="btn-group">
					<label class="btn btn-sm btn-white"> <input id="option1" name="options" type="radio"> Day </label>
					<label class="btn btn-sm btn-white active"> <input id="option2" name="options" type="radio"> Week </label>
					<label class="btn btn-sm btn-white"> <input id="option3" name="options" type="radio"> Month </label>
				</div>
			</div>
			<div class="col-sm-3">
