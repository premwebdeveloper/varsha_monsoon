...
<div class="row">
    <div class="col-lg-12">
        <div class="ibox">
            ...
            <?= form_open_multipart("Admin/addOffer", '', array('class' => 'wizard-big', 'role' => 'form'));?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label>Title *</label>
                                    <input id="title" name="title" type="text" class="form-control required" required="required">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label>Price *</label>
                                    <input id="price" name="price" type="number" class="form-control required" required="required">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="description" style="height: 106px;" name="description" class="form-control required "></textarea>
